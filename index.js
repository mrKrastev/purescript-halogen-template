...
(function($PS) {
  ...
  "use strict";
  $PS["SupJS"] = $PS["SupJS"] || {};
  var exports = $PS["SupJS"];
  var $foreign = $PS["SupJS"];
  exports["cleanInputBox"] = $foreign.cleanInputBox;
  exports["disableInputBox"] = $foreign.disableInputBox;
  exports["startGame"] = $foreign.startGame;
  exports["changeParticleSpeed"] = $foreign.changeParticleSpeed;
  exports["resizeMagic"] = $foreign.resizeMagic;
  exports["renderMagicJs"] = $foreign.renderMagicJs;
  exports["fixPVPmagic"] = $foreign.fixPVPmagic;
  exports["changeParticleSpeed2"] = $foreign.changeParticleSpeed2;
})(PS);
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
...
(function($PS) {
  "use strict";
  $PS["App.EntryPoint"] = $PS["App.EntryPoint"] || {};
  var exports = $PS["App.EntryPoint"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var PVE = (function () {
      ...
      PVE.create = function (value0) {
          return new PVE(value0);
      };
      return PVE;
  })();
  var PVP = (function () {
      ...
      PVP.create = function (value0) {
          return new PVP(value0);
      };
      return PVP;
  })();
  var Entry = (function () {
  ...
  var RunEntrypvp = (function () {
      function RunEntrypvp() {

      };
      RunEntrypvp.value = new RunEntrypvp();
      return RunEntrypvp;
  })();
  var Updatepvp = (function () {
      function Updatepvp(value0) {
          this.value0 = value0;
      };
      Updatepvp.create = function (value0) {
          return new Updatepvp(value0);
      };
      return Updatepvp;
  })();
  var SendInputpvp = (function () {
      function SendInputpvp(value0) {
          this.value0 = value0;
      };
      SendInputpvp.create = function (value0) {
          return new SendInputpvp(value0);
      };
      return SendInputpvp;
  })();
  var DecrementInitialTimer = (function () {
      function DecrementInitialTimer(value0) {
          this.value0 = value0;
      };
      DecrementInitialTimer.create = function (value0) {
          return new DecrementInitialTimer(value0);
      };
      return DecrementInitialTimer;
  })();
  var Decrementpvp = (function () {
      function Decrementpvp(value0) {
          this.value0 = value0;
      };
      Decrementpvp.create = function (value0) {
          return new Decrementpvp(value0);
      };
      return Decrementpvp;
  })();
  ...
  var UpdatePlayer2 = (function () {
      function UpdatePlayer2(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      UpdatePlayer2.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new UpdatePlayer2(value0, value1, value2);
              };
          };
      };
      return UpdatePlayer2;
  })();
  var SetPlayerConnected = (function () {
      function SetPlayerConnected(value0, value1, value2) {
          this.value0 = value0;
          this.value1 = value1;
          this.value2 = value2;
      };
      SetPlayerConnected.create = function (value0) {
          return function (value1) {
              return function (value2) {
                  return new SetPlayerConnected(value0, value1, value2);
              };
          };
      };
      return SetPlayerConnected;
  })();
  var RunEntry = (function () {
      function RunEntry() {

      };
      RunEntry.value = new RunEntry();
      return RunEntry;
  })();
  var Update = (function () {
      function Update() {
  ...
  var SendInput = (function () {
      function SendInput(value0) {
          this.value0 = value0;
      };
      SendInput.create = function (value0) {
          return new SendInput(value0);
      };
      return SendInput;
  })();
  ...
  var RunPVE = (function () {
      ...
      RunPVE.value = new RunPVE();
      return RunPVE;
  })();
  var RunPVP = (function () {
      function RunPVP(value0) {
          this.value0 = value0;
      };
      RunPVP.create = function (value0) {
          return new RunPVP(value0);
      };
      return RunPVP;
  })();
  ...
  var ActionEntry = (function () {
      function ActionEntry(value0) {
          this.value0 = value0;
      };
      ActionEntry.create = function (value0) {
          return new ActionEntry(value0);
      };
      return ActionEntry;
  })();
  var ActionPVE = (function () {
      function ActionPVE(value0) {
          this.value0 = value0;
      };
      ActionPVE.create = function (value0) {
          return new ActionPVE(value0);
      };
      return ActionPVE;
  })();
  var ActionPVP = (function () {
      function ActionPVP(value0) {
          this.value0 = value0;
      };
      ActionPVP.create = function (value0) {
          return new ActionPVP(value0);
      };
      return ActionPVP;
  })();
  var zombiePushValue = function (dictEq) {
      return function (input) {
          return function (word) {
              if (Data_Eq.eq(dictEq)(input)(word)) {
                  return 2.0;
              };
              if (Data_Boolean.otherwise) {
                  return -4.0;
  ...
  var updatePVP = function (fn) {
      return function (v) {
          if (v instanceof PVP) {
              return new PVP(fn(v.value0));
          };
          return v;
      };
  };
  var updatePVE = function (fn) {
      return function (v) {
          if (v instanceof PVE) {
              return new PVE(fn(v.value0));
          };
          return v;
      };
  };
  var updateName = function (fn) {
      return function (v) {
          if (v instanceof Entry) {
              return new Entry(fn(v.value0));
          };
          return v;
      };
  };
  var timerVisibility = function (timer) {
      if (timer > 0) {
          return "position:absolute;left:40%;color:yellow;font:40px Comic Sans;min-width:300px;text-align:center;visibility:visible;";
      };
      if (Data_Boolean.otherwise) {
          return "position:absolute;left:40%;color:yellow;font:40px Comic Sans;min-width:300px;text-align:center;visibility:hidden;";
      };
  ...
  var pveOutcome = function (outcome) {
      if (outcome === "Win") {
          return "width:100%;margin: 50px auto;text-align: center;text-shadow: -1px -1px 0px rgba(255,255,255,0.3), 1px 1px 0px rgba(0,0,0,0.8);color:rgba(30, 130, 76, 1);opacity: 1;font: 700 80px 'Bitter'";
      };
      if (Data_Boolean.otherwise) {
          return "width:100%;margin: 50px auto;text-align: center;text-shadow: -1px -1px 0px rgba(255,255,255,0.3), 1px 1px 0px rgba(0,0,0,0.8);color:rgba(150, 40, 27, 1);opacity: 1;font: 700 80px 'Bitter'";
      };
      throw new Error("Failed pattern match at App.EntryPoint (line 615, column 1 - line 615, column 31): " + [ outcome.constructor.name ]);
  };

  //CSS kek------------------------------------------------------------------------------------------------------------------------------
  var modalCSS = function (flag) {
      if (flag === true) {
          return "width:50%; height:wrap-content;left:25%;top:15%;z-index:999; position:absolute;background-color:#23272a;display:block;justify-content:space-between;overflow:wrap;border-width:5px;border-style:groove;border-color:orange;";
      };
      if (Data_Boolean.otherwise) {
          return "width:50%; height:wrap-content;left:25%;top:15%;z-index:999; position:absolute;background-color:#23272a;display:none;border-width:5px;border-style:groove;border-color:orange;";
      };
  ...
  var messageToAction = function (msg) {
      var parseSetPlayer = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonMaybe(Data_Argonaut_Decode_Class.decodeJsonNumber))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Applicative.pure(Data_Either.applicativeEither)(new UpdatePlayer2(v.player2WPM, v.correctWords, v.playerID));
          });
      };
      var parseSetIt = function (json) {
          return Control_Bind.bind(Data_Either.bindEither)(Data_Argonaut_Decode_Class.decodeJson(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonString)(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeJsonInt)(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
              ...
              return Control_Applicative.pure(Data_Either.applicativeEither)(new SetPlayerConnected(v.playerID, v.name, v.textNumber));
          });
      };
  ...
  var magicPushCalculator = function (dictEq) {
      return function (input) {
          return function (word) {
              if (Data_Eq.eq(dictEq)(input)(word)) {
                  return 10.0;
  ...
  var lore = [ text1, text2, text3, text4, text5 ];
  var inputBoxCSS = "border: none;border-bottom: 2px solid orange;background:transparent; width:60%;height:60px;font-size:50px;color:white;text-align:center;margin:10px;";
  var initialPVPstate = function (webSocket) {
      return function (name) {
          return function (id) {
              return function (textNumber) {
                  return {
                      wrongWordCounter: 0,
                      wordCounter: 0,
                      myTimeNow: Data_Maybe.Nothing.value,
                      myFirstTime: Data_Maybe.Nothing.value,
                      timeDifference: Data_Maybe.Nothing.value,
                      timer: 60,
                      timerIsRunning: false,
                      wpm: Data_Maybe.Nothing.value,
                      particlesWidth: 350.0,
                      enemyWPM: Data_Maybe.Nothing.value,
                      webSocket: webSocket,
                      playerName: name,
  ...
  var initialPVEstate = function (textNum) {
      return {
          wpm: Data_Maybe.Nothing.value,
          timerIsRunning: false,
          timer: 60,
  ...
  var incrementor = function (dictEq) {
      return function (input) {
          return function (word) {
              if (Data_Eq.eq(dictEq)(input)(word)) {
                  return 0;
  ...
  var generateRandomNumber = Effect_Random.randomInt(100000)(999999);
  var generateFlavourText = function (wpm1) {
      return function (wpm2) {
          if (wpm1 > wpm2) {
              return "You were " + (Data_Number_Format.toStringWith(Data_Number_Format.precision(3))((wpm1 / wpm2 - 1.0) * 100.0) + "% faster than your opponent!");
          };
          if (wpm1 < wpm2) {
              return "You were " + (Data_Number_Format.toStringWith(Data_Number_Format.precision(3))((wpm2 / wpm1 - 1.0) * 100.0) + "% slower than your opponent!");
          };
          if (Data_Boolean.otherwise) {
              return "Your magical power levels are matching!";
          };
  ...
  var pickLore = function (position) {
      return fromJustString(Data_Array.index(lore)(position));
  };
  var myWords = function ($$int) {
      return Data_String_Common.split(" ")(pickLore($$int));
  };
  var fromJustNumber = function (v) {
      if (v instanceof Data_Maybe.Nothing) {
          return 1.0;
      };
      if (v instanceof Data_Maybe.Just) {
  ...
  // pure functions --------------------------------------------------------------------------------------------------------------------
  var decideWinner = function (dictOrd) {
      return function (dictOrd1) {
          return function (dictOrd2) {
              return function (p1Words) {
                  return function (p2Words) {
                      return function (p1WPM) {
                          return function (p2WPM) {
                              if (Data_Ord.greaterThan(dictOrd)(p1Words)(p2Words)) {
                                  return "Victory";
                              };
                              if (Data_Ord.lessThan(dictOrd)(p1Words)(p2Words)) {
                                  return "Defeat";
                              };
                              if (Data_Ord.greaterThan(dictOrd1)(p1WPM)(p2WPM)) {
                                  return "Victory";
                              };
                              if (Data_Ord.lessThan(dictOrd1)(p1WPM)(p2WPM)) {
                                  return "Defeat";
                              };
                              if (Data_Boolean.otherwise) {
                                  return "Draw";
  ...
  var calculateMagicPush = function (p1Words) {
      return function (p2Words) {
          if (p1Words < p2Words) {
              return -10.0;
          };
  ...
  var calcWPMTimer = function (wordsCount) {
      return function (time) {
          return (wordsCount / (60.0 - time)) * 60.0;
      };
  };
  var calcWPM = function (wordsCount) {
      return function (v) {
          if (v instanceof Data_Maybe.Just) {
              return new Data_Maybe.Just((Data_Int.toNumber(wordsCount) / v.value0) * 60.0);
          };
          if (v instanceof Data_Maybe.Nothing) {
              return Data_Maybe.Nothing.value;
          };
  ...
  var buttonsCss = function (color1) {
      return function (color2) {
          return "width:200px;height:70px;" + ("background: linear-gradient(to left top, #" + (color1 + (" 50%, #" + (color2 + (" 50%);" + ("border-style: none;" + ("color:#fff;" + ("font-size: 23px;" + ("letter-spacing: 3px;" + ("font-family: 'Lato';" + ("font-weight: 600;" + ("outline: none;" + ("position: relative;" + ("margin: 10px;" + ("overflow: hidden;" + "box-shadow: 0px 1px 2px rgba(0,0,0,.2);")))))))))))))));
      };
  };
  var battleOutcomeTitle = function (outcome) {
      if (outcome === "Victory") {
          return "width:100%;margin: 50px auto;text-align: center;text-shadow: -1px -1px 0px rgba(255,255,255,0.3), 1px 1px 0px rgba(0,0,0,0.8);color:rgba(30, 130, 76, 1);opacity: 1;font: 700 80px 'Bitter'";
      };
      if (outcome === "Defeat") {
      ...
      if (Data_Boolean.otherwise) {
          return ":width:100%;margin: 50px auto;text-align: center;text-shadow: -1px -1px 0px rgba(255,255,255,0.3), 1px 1px 0px rgba(0,0,0,0.8);color:rgba(75, 119, 190, 1);opacity: 1;font: 700 80px 'Bitter'";
      };
      throw new Error("Failed pattern match at App.EntryPoint (line 609, column 1 - line 609, column 39): " + [ outcome.constructor.name ]);
  };
  var entryComponent = function (dictMonadEffect) {
      return function (dictMonadAff) {
          var render = function (v) {
              if (v instanceof Entry) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:80%; background-color:#2c2f33; display:flex;flex-wrap:wrap; justify-content:center;allign-items:center;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style(flexDivCenterItems) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.style(buttonsCss("1392A4")("0AD4F0")), Halogen_HTML_Events.onClick(function (v1) {
                      return new Data_Maybe.Just(new ActionEntry(RunPVE.value));
                  }) ])([ Halogen_HTML_Core.text("Play PVE") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style(flexDivCenterItems) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Properties.style(buttonsCss("BC6513")("E48D3A")), Halogen_HTML_Events.onClick(function (v1) {
                      return new Data_Maybe.Just(new ActionEntry(RunPVP.create(fromJustString(v.value0.name))));
                  }) ])([ Halogen_HTML_Core.text("Play PVP") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style(flexDivCenterItems) ])([ Halogen_HTML_Elements.input([ Halogen_HTML_Properties.placeholder("What is your name?"), Halogen_HTML_Properties.style(inputBoxCSS), Halogen_HTML_Events.onValueInput(function (s) {
                      return new Data_Maybe.Just(new ActionEntry(new SetName(s)));
                  }) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style(flexDivCenterItems) ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:yellow;font:40px Comic Sans;min-width:300px;text-align:center;") ])([ Halogen_HTML_Core.text("Wizard name: " + fromJustString(v.value0.name)) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style(flexDivCenterItems) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/grimoire.png"), Halogen_HTML_Properties.height(400), Halogen_HTML_Properties.width(600) ]) ]) ]);
              };
              if (v instanceof PVP) {
              ...
              if (v instanceof PVE) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:50%; background-color:#2c2f33;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style(modalCSS(v.value0.showGameEndModal)) ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style(pveOutcome(v.value0.combatOutcome)) ])([ Halogen_HTML_Core.text(v.value0.combatOutcome) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;width:100%;height:100px;") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("width:100%;font-size:30px;color:cyan;text-shadow: 0px 0px 5px #555;margin:10px;text-align:center;") ])([ Halogen_HTML_Core.text("WPM: " + Data_Number_Format.toStringWith(Data_Number_Format.precision(3))(fromJustNumber(v.value0.wpm))) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;width:100%;height:100px;") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("width:100%;font-size:30px;color:cyan;text-shadow: 0px 0px 5px #555;margin:10px;text-align:center;") ])([ Halogen_HTML_Core.text("Correct Words: " + Data_Show.show(Data_Show.showInt)(v.value0.wordCounter - v.value0.wrongWordCounter | 0)) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;width:100%;height:100px;") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("width:100%;font-size:20px;color:orange;text-shadow: 0px 0px 5px #555;margin:10px;text-align:center;") ])([ Halogen_HTML_Core.text("You typed " + (Data_Number_Format.toStringWith(Data_Number_Format.precision(3))(fromJustNumber(v.value0.wpm) / 60.0) + " words in a second!")) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;margin-top:10%") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display:inline-flex;width:100%;justify-self:center;margin-top:10%;background-color:transparent;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;left:0px;top:50px") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/mage.gif"), Halogen_HTML_Properties.height(150), Halogen_HTML_Properties.width(200) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;left:" + (Data_Show.show(Data_Show.showNumber)(v.value0.zombiePosition) + "px;")) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/zombie-pve.gif"), Halogen_HTML_Properties.height(200), Halogen_HTML_Properties.width(150) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:100%; background-color:#2c2f33;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;margin-top:10%") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("font: 40px Tahoma, Helvetica, Arial, Sans-Serif;text-align: center;color:orange;text-shadow: 0px 2px 3px #555;min-width:100%") ])([ Halogen_HTML_Core.text(fromJustString(Data_Array.index(myWords(v.value0.textNo))(v.value0.wordCounter)) + (" " + (fromJustString(Data_Array.index(myWords(v.value0.textNo))(v.value0.wordCounter + 1 | 0)) + (" " + fromJustString(Data_Array.index(myWords(v.value0.textNo))(v.value0.wordCounter + 2 | 0)))))) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.id_("inp"), Halogen_HTML_Events.onValueChange(function (s) {
                      return new Data_Maybe.Just(new ActionPVE(new SendInput(s)));
                  }), Halogen_HTML_Properties.style(" color:white; height:50px;width:150px; margin-left:20%; margin-top:5%; margin-bottom:10%;font-size:24px;border-color:orange;background-color:transparent;") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:yellow;font:40px Comic Sans;min-width:300px;text-align:center;") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v.value0.timer) + " seconds left") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:lightblue;font:24px Comic Sans;min-width:300px;") ])([ Halogen_HTML_Core.text(" WPM: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showNumber))(v.value0.wpm)) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:lightgreen;font:24px Comic Sans;min-width:300px;") ])([ Halogen_HTML_Core.text("  Correct words: " + (Data_Show.show(Data_Show.showInt)(v.value0.wordCounter - v.value0.wrongWordCounter | 0) + (" " + (" Wrong words: " + Data_Show.show(Data_Show.showInt)(v.value0.wrongWordCounter))))) ]) ]) ]);
              };
              throw new Error("Failed pattern match at App.EntryPoint (line 413, column 5 - line 443, column 10): " + [ v.constructor.name ]);
          };
          var handleActionPVP = function ($copy_v) {
              var $tco_done = false;
              var $tco_result;
              function $tco_loop(v) {
                  if (v instanceof SendInputpvp) {
                      $tco_done = true;
                          ...
                          if (state instanceof PVP) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.nowTime))(function (mynowtime) {
                                      var myNewWordCounter = state.value0.wordCounter + 1 | 0;
                                      var timeDifference = Control_Apply.lift2(Data_Maybe.applyMaybe)(Data_Time.diff(Data_Time_Duration.durationSeconds))(new Data_Maybe.Just(mynowtime))(state.value0.myFirstTime);
                                      var myText = fromJustString(Data_Array.index(myWords(state.value0.textNo))(state.value0.wordCounter));
                                      var myNewWrongWordCounter = state.value0.wrongWordCounter + incrementor(Data_Eq.eqString)(v.value0)(myText) | 0;
                                      var myNewWPM = calcWPM(myNewWordCounter - myNewWrongWordCounter | 0)(timeDifference);
                                      var correctWords = myNewWordCounter - myNewWrongWordCounter | 0;
                                      var particlesWidthUpdate = state.value0.particlesWidth + magicPushCalculator(Data_Eq.eqString)(v.value0)(myText);
                                      var newMagic = SupJS.resizeMagic(state.value0.particlesWidth);
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                              return {
                                                  ...
                                                  myTimeNow: new Data_Maybe.Just(mynowtime),
                                                  myFirstTime: st.myFirstTime,
                                                  timeDifference: timeDifference,
                                                  timer: st.timer,
                                                  timerIsRunning: st.timerIsRunning,
                                                  wpm: myNewWPM,
                                                  particlesWidth: particlesWidthUpdate,
                                                  enemyWPM: st.enemyWPM,
                                                  webSocket: st.webSocket,
                                                  playerName: st.playerName,
                                                  enemyName: st.enemyName,
                                                  enemyCorrectWords: st.enemyCorrectWords,
                                                  notInitialized: st.notInitialized,
                                                  readyTimeoutTimer: st.readyTimeoutTimer,
                                                  showGameEndModal: st.showGameEndModal,
                                                  combatOutcome: st.combatOutcome,
                  ...
                  if (v instanceof Updatepvp) {
                      $tco_done = true;
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                          if (state instanceof PVP) {
                              var correctWords = state.value0.wordCounter - state.value0.wrongWordCounter | 0;
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Socket_WebSocket.sendString(state.value0.webSocket)(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonMaybe(Data_Argonaut_Encode_Class.encodeJsonJNumber))(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                                  return "playerID";
                              }))())(new Data_Symbol.IsSymbol(function () {
                                  return "player2WPM";
                              }))())(new Data_Symbol.IsSymbol(function () {
                                  ...
                                  playerID: state.value0.myID,
                                  player2WPM: state.value0.wpm,
                      ...
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                          if (state instanceof PVP) {
                              ...
                              if ($109) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                      return {
                                          ...
                                          wordCounter: st.wordCounter,
                                          myTimeNow: st.myTimeNow,
                                          myFirstTime: st.myFirstTime,
                                          timeDifference: st.timeDifference,
                                          timer: newtimer,
                                          timerIsRunning: st.timerIsRunning,
                                          wpm: new Data_Maybe.Just(calcWPMTimer(Data_Int.toNumber(state.value0.wordCounter) - Data_Int.toNumber(state.value0.wrongWordCounter))(Data_Int.toNumber(newtimer))),
                                          particlesWidth: state.value0.particlesWidth,
                                          enemyWPM: st.enemyWPM,
                                          webSocket: st.webSocket,
                                          playerName: st.playerName,
                                          enemyName: st.enemyName,
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe(v.value0))(function () {
                                  var myCorrectWords = state.value0.wordCounter - state.value0.wrongWordCounter | 0;
                                  var outcome = decideWinner(Data_Ord.ordInt)(Data_Ord.ordNumber)(Data_Ord.ordNumber)(myCorrectWords)(state.value0.enemyCorrectWords)(wpmSetup(state.value0.wpm))(wpmSetup(state.value0.enemyWPM));
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                      return {
                                          wrongWordCounter: st.wrongWordCounter,
                                          wordCounter: st.wordCounter,
                                          ...
                                          timerIsRunning: st.timerIsRunning,
                                          wpm: st.wpm,
                                          particlesWidth: st.particlesWidth,
                                          enemyWPM: st.enemyWPM,
                                          webSocket: st.webSocket,
                                          playerName: st.playerName,
                                          enemyName: st.enemyName,
                  ...
                  if (v instanceof DecrementInitialTimer) {
                      $tco_done = true;
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                          if (state instanceof PVP) {
                              ...
                              if ($113) {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                      return {
                                          ...
                                          enemyCorrectWords: st.enemyCorrectWords,
                                          notInitialized: st.notInitialized,
                                          readyTimeoutTimer: newTimeoutTimer,
                                          showGameEndModal: st.showGameEndModal,
                                          combatOutcome: st.combatOutcome,
                                          hasOpponent: st.hasOpponent,
                                          opponentID: st.opponentID,
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.nowTime))(function (mynowtime) {
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                          return {
                                              ...
                                              wordCounter: st.wordCounter,
                                              myTimeNow: st.myTimeNow,
                                              myFirstTime: new Data_Maybe.Just(mynowtime),
                                              timeDifference: st.timeDifference,
                                              timer: st.timer,
                                              timerIsRunning: true,
                                              wpm: st.wpm,
                                          ...
                                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid2) {
                                              return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                                                  return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(repeatAction(emitter)(1000.0)(new ActionPVP(new Decrementpvp(sid2)))))(function () {
                                                      return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Monoid.mempty(Halogen_Query_EventSource.monoidFinalizer(Effect_Aff.applicativeAff)));
                                                  });
                                              });
                                          }))(function () {
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid3) {
                                                  return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                                                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(repeatAction(emitter)(100.0)(new ActionPVP(new Updatepvp(sid3)))))(function () {
                                                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Monoid.mempty(Halogen_Query_EventSource.monoidFinalizer(Effect_Aff.applicativeAff)));
                                                      });
                                                  });
                                              }))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function () {
                                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(SupJS.startGame(Data_Unit.unit)))(function () {
                                                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                                      });
                                                  });
                                              });
                  ...
                  if (v instanceof ReceiveMessage) {
                      ...
                      if (v1 instanceof Data_Either.Left) {
                          $tco_done = true;
                          return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)(v1.value0));
                      };
                      if (v1 instanceof Data_Either.Right) {
                          $copy_v = v1.value0;
                          return;
                  ...
                  if (v instanceof UpdatePlayer2) {
                      $tco_done = true;
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("updatePlayer"))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  if (state instanceof PVP) {
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Show.show(Data_Show.showNumber)(updatedParticlesWidth)))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                                  return {
                                                      ...
                                                      timerIsRunning: st.timerIsRunning,
                                                      wpm: st.wpm,
                                                      particlesWidth: updatedParticlesWidth,
                                                      enemyWPM: v.value0,
                                                      webSocket: st.webSocket,
                                                      playerName: st.playerName,
                                                      enemyName: st.enemyName,
                                                      enemyCorrectWords: v.value1,
                                                      notInitialized: st.notInitialized,
                                                      readyTimeoutTimer: st.readyTimeoutTimer,
                                                      showGameEndModal: st.showGameEndModal,
                                                      combatOutcome: st.combatOutcome,
                  ...
                  if (v instanceof SetPlayerConnected) {
                      $tco_done = true;
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                          if (state instanceof PVP) {
                              ...
                              if ($127) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Socket_WebSocket.sendString(state.value0.webSocket)(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                                              return "textNumber";
                                          }))())(new Data_Symbol.IsSymbol(function () {
                                              return "playerID";
                                          }))())(new Data_Symbol.IsSymbol(function () {
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                                  ...
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                      return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                                                          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(repeatAction(emitter)(1000.0)(new ActionPVP(new DecrementInitialTimer(sid)))))(function () {
                                                              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Monoid.mempty(Halogen_Query_EventSource.monoidFinalizer(Effect_Aff.applicativeAff)));
                                                          });
                                                      });
                                                  }))(function () {
          ...
          var handleActionPVE = function (v) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Show.show(Data_Show.showBoolean)(state.value0.timerIsRunning)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.nowTime))(function (mynowtime) {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVE(function (st) {
                                              return {
                                                  ...
                                                  timerIsRunning: true,
                                                  wpm: st.wpm,
                                                  zombiePosition: st.zombiePosition,
                                                  particlesWidth: st.particlesWidth,
                                                  showGameEndModal: st.showGameEndModal,
                                                  combatOutcome: st.combatOutcome,
                                                  textNo: st.textNo
                                              ...
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                  return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                                                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(repeatAction(emitter)(1000.0)(new ActionPVE(new Decrement(sid)))))(function () {
                                                          return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Monoid.mempty(Halogen_Query_EventSource.monoidFinalizer(Effect_Aff.applicativeAff)));
                                                      });
                                                  });
                                              }))(function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.nowTime))(function (mynowtime) {
                                      ...
                                      var myNewWrongWordCounter = state.value0.wrongWordCounter + incrementor(Data_Eq.eqString)(v.value0)(myText) | 0;
                                      var myNewWPM = calcWPM(myNewWordCounter - myNewWrongWordCounter | 0)(timeDifference);
                                      var myNewZombiePosition = state.value0.zombiePosition + zombiePushValue(Data_Eq.eqString)(v.value0)(myText);
              ...
              if (v instanceof Update) {
                  return Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("heh");
              };
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Show.show(Data_Show.showInt)(state.value0.timer)))(function () {
                              ...
                              if ($139) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVE(function (st) {
                                      return {
                                          ...
                                          timerIsRunning: st.timerIsRunning,
                                          wpm: new Data_Maybe.Just(calcWPMTimer(Data_Int.toNumber(state.value0.wordCounter) - Data_Int.toNumber(state.value0.wrongWordCounter))(Data_Int.toNumber(newtimer))),
                                          zombiePosition: newZombiePosition,
                                          particlesWidth: st.particlesWidth,
                                          showGameEndModal: st.showGameEndModal,
                                          combatOutcome: st.combatOutcome,
                                          textNo: st.textNo
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe(v.value0))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                      ...
                                      var timeDifference = sixtySec(60);
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVE(function (st) {
                                          return {
                                              wrongWordCounter: st.wrongWordCounter,
                                              wordCounter: st.wordCounter,
                                              ...
                                              timer: st.timer,
                                              timerIsRunning: st.timerIsRunning,
                                              wpm: calcWPM(state.value0.wordCounter - state.value0.wrongWordCounter | 0)(new Data_Maybe.Just(timeDifference)),
                                              zombiePosition: st.zombiePosition,
                                              particlesWidth: st.particlesWidth,
                                              showGameEndModal: st.showGameEndModal,
                                              combatOutcome: st.combatOutcome,
              ...
              if (v instanceof RunEntry) {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              };
              throw new Error("Failed pattern match at App.EntryPoint (line 340, column 23 - line 411, column 30): " + [ v.constructor.name ]);
          };
          var handleActionEntry = function (v) {
              if (v instanceof RunPVE) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Random.randomInt(0)(4)))(function (random) {
                      var textNumber = fromJustInt(Data_Int_Parse["parseInt"](Data_Show.show(Data_Show.showInt)(random))(Data_Int_Parse.toRadix(10)));
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new PVE(initialPVEstate(textNumber))))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(SupJS.renderMagicJs(Data_Unit.unit)))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              });
                          });
                      });
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(100.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(WSListener.setupWSListener(ws)(function (msg) {
                                  return Halogen_Query_EventSource.emit(emitter)(ActionPVP.create(new ReceiveMessage(msg)));
                              })))(function (fiber) {
                              ...
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(generateRandomNumber))(function (myid) {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Random.randomInt(0)(4)))(function (random) {
                                      var textNumber = fromJustInt(Data_Int_Parse["parseInt"](Data_Show.show(Data_Show.showInt)(random))(Data_Int_Parse.toRadix(10)));
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new PVP(initialPVPstate(ws)(v.value0)(Data_Show.show(Data_Show.showInt)(myid))(textNumber))))(function () {
                                          var playerID = Data_Show.show(Data_Show.showInt)(myid);
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Socket_WebSocket.sendString(ws)(Data_Argonaut_Core.stringify(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeRecord(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonJString)(Data_Argonaut_Encode_Class.gEncodeJsonCons(Data_Argonaut_Encode_Class.encodeJsonInt)(Data_Argonaut_Encode_Class.gEncodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                                              return "textNumber";
                                          }))())(new Data_Symbol.IsSymbol(function () {
                                              return "playerID";
                                          }))())(new Data_Symbol.IsSymbol(function () {
                                              ...
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(SupJS.fixPVPmagic(Data_Unit.unit))))(function () {
                                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                                              });
                                          });
                                      });
              ...
              if (v instanceof SetName) {
                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updateName(function (st) {
                      return {
          ...
          var handleActionPicker = function (v) {
              if (v instanceof ActionEntry) {
                  return handleActionEntry(v.value0);
              };
              if (v instanceof ActionPVE) {
                  return handleActionPVE(v.value0);
              };
              if (v instanceof ActionPVP) {
                  return handleActionPVP(v.value0);
              };
          ...
          return Halogen_Component.mkComponent({
              initialState: function (v) {
                  return new Entry(initialEntrystate);
              },
              render: render,
              "eval": Halogen_Component.mkEval({
                  handleAction: handleActionPicker,
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var App_EntryPoint = $PS["App.EntryPoint"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_DOM_Element.setAttribute("style")("background-color:\x09#23272a;display:flex;flex-wrap:wrap;justify-content:center;color:#FF8C00")(Web_HTML_HTMLElement.toElement(body))))(function () {
          return Halogen_VDom_Driver.runUI(App_EntryPoint.entryComponent(Effect_Aff.monadEffectAff)(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
      });
  }));
  exports["main"] = main;
})(PS);
