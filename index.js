...
(function($PS) {
  // Generated by purs version 0.13.8
  "use strict";
  $PS["App.MainApp"] = $PS["App.MainApp"] || {};
  var exports = $PS["App.MainApp"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Apply = $PS["Control.Apply"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Monad_State_Class = $PS["Control.Monad.State.Class"];
  ...
  var zombiePushValue = function (dictEq) {
      return function (input) {
          return function (word) {
              ...
              throw new Error("Failed pattern match at App.MainApp (line 150, column 1 - line 150, column 58): " + [ input.constructor.name, word.constructor.name ]);
          };
      };
  };
  ...
  var incrementor = function (dictEq) {
      return function (input) {
          return function (word) {
              ...
              throw new Error("Failed pattern match at App.MainApp (line 145, column 1 - line 145, column 51): " + [ input.constructor.name, word.constructor.name ]);
          };
      };
  };
  var fromJustString = function (v) {
      ...
      throw new Error("Failed pattern match at App.MainApp (line 56, column 1 - line 56, column 41): " + [ v.constructor.name ]);
  };
  var render = function (state) {
      return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:50%; background-color:#2c2f33;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;margin-top:10%") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display:inline-flex;width:100%;justify-self:center;margin-top:10%;background-color:transparent;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;left:0px;top:50px") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/mage.gif"), Halogen_HTML_Properties.height(150), Halogen_HTML_Properties.width(200) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;left:" + (Data_Show.show(Data_Show.showNumber)(state.zombiePosition) + "px;")) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/zombie-pve.gif"), Halogen_HTML_Properties.height(200), Halogen_HTML_Properties.width(150) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:100%; background-color:#2c2f33;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;margin-top:10%") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("font: 40px Tahoma, Helvetica, Arial, Sans-Serif;text-align: center;color:orange;text-shadow: 0px 2px 3px #555;min-width:100%") ])([ Halogen_HTML_Core.text(fromJustString(Data_Array.index(myWords)(state.wordCounter)) + (" " + (fromJustString(Data_Array.index(myWords)(state.wordCounter + 1 | 0)) + (" " + fromJustString(Data_Array.index(myWords)(state.wordCounter + 2 | 0)))))) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.id_("inp"), Halogen_HTML_Events.onValueChange(function (s) {
          return new Data_Maybe.Just(new SendInput(s));
      }), Halogen_HTML_Properties.style(" color:white; height:50px;width:150px; margin-left:20%; margin-top:5%; margin-bottom:10%;font-size:24px;border-color:orange;background-color:transparent;") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:yellow;font:40px Comic Sans;min-width:300px;text-align:center;") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state.timer) + " seconds left") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:lightblue;font:24px Comic Sans;min-width:300px;") ])([ Halogen_HTML_Core.text(" WPM: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showNumber))(state.wpm)) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:lightgreen;font:24px Comic Sans;min-width:300px;") ])([ Halogen_HTML_Core.text("  Correct words: " + (Data_Show.show(Data_Show.showInt)(state.wordCounter - state.wrongWordCounter | 0) + (" " + (" Wrong words: " + Data_Show.show(Data_Show.showInt)(state.wrongWordCounter))))) ]) ]) ]);
  };
  var calcWPM = function (wordsCount) {
      return function (v) {
          ...
          throw new Error("Failed pattern match at App.MainApp (line 60, column 1 - line 60, column 46): " + [ wordsCount.constructor.name, v.constructor.name ]);
      };
  };
      ...
      return function (dictMonadAff) {
          return function (v) {
              if (v instanceof SendInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $27 = state.timerIsRunning === false;
                          if ($27) {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.nowTime))(function (mynowtime) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                      ...
                                      $28.timerIsRunning = true;
                                      $28.myFirstTime = new Data_Maybe.Just(mynowtime);
                                      return $28;
                                  }))(function () {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                          return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                                              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(repeatAction(emitter)(1000.0)(new Decrement(sid))))(function () {
                          ...
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.nowTime))(function (mynowtime) {
                              var timeDifference = Control_Apply.lift2(Data_Maybe.applyMaybe)(Data_Time.diff(Data_Time_Duration.durationSeconds))(new Data_Maybe.Just(mynowtime))(state.myFirstTime);
                              var myText = fromJustString(Data_Array.index(myWords)(state.wordCounter));
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  var $31 = {};
                                  for (var $32 in st) {
                                  ...
                                  $31.wordCounter = st.wordCounter + 1 | 0;
                                  $31.myTimeNow = new Data_Maybe.Just(mynowtime);
                                  $31.timeDifference = timeDifference;
                                  $31.wpm = calcWPM(st.wordCounter - st.wrongWordCounter | 0)(timeDifference);
                                  $31.wrongWordCounter = st.wrongWordCounter + incrementor(Data_Eq.eqString)(v.value0)(myText) | 0;
                                  $31.zombiePosition = st.zombiePosition + zombiePushValue(Data_Eq.eqString)(v.value0)(myText);
                                  return $31;
                              }))(function () {
              ...
              if (v instanceof Decrement) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                      var $35 = state.timer > 0 && state.zombiePosition > -150.0;
                      if ($35) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $36.timer = st.timer - 1 | 0;
                              $36.zombiePosition = st.zombiePosition - 8.0;
                              return $36;
                          });
                      };
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe(v.value0))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(SupJS.disableInputBox(Data_Unit.unit)))(function () {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                  ...
                                  $39.wpm = calcWPM(st.wordCounter - st.wrongWordCounter | 0)(new Data_Maybe.Just(timeDifference));
                                  return $39;
                              }))(function () {
                                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                              });
              ...
              throw new Error("Failed pattern match at App.MainApp (line 158, column 16 - line 201, column 18): " + [ v.constructor.name ]);
          };
      };
  };
...
(function($PS) {
  ...
  $PS["Main"] = $PS["Main"] || {};
  var exports = $PS["Main"];
  var App_MainApp = $PS["App.MainApp"];
  var Control_Bind = $PS["Control.Bind"];
  var Data_Unit = $PS["Data.Unit"];
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Aff_Class = $PS["Effect.Aff.Class"];
  ...
  var main = Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
      return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Web_DOM_Element.setAttribute("style")("background-color:\x09#23272a;display:flex;flex-wrap:wrap;justify-content:center;color:#FF8C00")(Web_HTML_HTMLElement.toElement(body))))(function () {
          return Halogen_VDom_Driver.runUI(App_MainApp.component(Effect_Aff.monadEffectAff)(Effect_Aff_Class.monadAffAff))(Data_Unit.unit)(body);
      });
  }));
  exports["main"] = main;
})(PS);
