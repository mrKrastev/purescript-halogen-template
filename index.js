...
(function($PS) {
  ...
  var zombiePushValue = function (dictEq) {
      return function (input) {
          return function (word) {
              ...
              throw new Error("Failed pattern match at App.EntryPoint (line 441, column 1 - line 441, column 58): " + [ input.constructor.name, word.constructor.name ]);
          };
      };
  };
  ...
  var myWords = Data_String_Common.split(" ")(myParagraph);       
  var magicPushCalculator = function (dictEq) {
      return function (input) {
          return function (word) {
              ...
              throw new Error("Failed pattern match at App.EntryPoint (line 445, column 1 - line 445, column 62): " + [ input.constructor.name, word.constructor.name ]);
          };
      };
  };
  ...
  var incrementor = function (dictEq) {
      return function (input) {
          return function (word) {
              ...
              throw new Error("Failed pattern match at App.EntryPoint (line 436, column 1 - line 436, column 51): " + [ input.constructor.name, word.constructor.name ]);
          };
      };
  };
  ...
  var fromJustString = function (v) {
      ...
      throw new Error("Failed pattern match at App.EntryPoint (line 406, column 1 - line 406, column 41): " + [ v.constructor.name ]);
  };
  var fromJustNumber = function (v) {
      ...
      throw new Error("Failed pattern match at App.EntryPoint (line 410, column 1 - line 410, column 41): " + [ v.constructor.name ]);
  };
  ...
  var calcWPM = function (wordsCount) {
      return function (v) {
          if (v instanceof Data_Maybe.Just) {
              return new Data_Maybe.Just((Data_Int.toNumber(wordsCount) / v.value0) * Data_Int.toNumber(60));
          };
          if (v instanceof Data_Maybe.Nothing) {
              return Data_Maybe.Nothing.value;
          };
          throw new Error("Failed pattern match at App.EntryPoint (line 414, column 1 - line 414, column 46): " + [ wordsCount.constructor.name, v.constructor.name ]);
      };
  };
      ...
      return function (dictMonadAff) {
          var render = function (v) {
              if (v instanceof Entry) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:50%; background-color:#2c2f33; display:grid; justify-content:center;allign-items:center;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:100%; background-color:transparent;") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v1) {
                      return new Data_Maybe.Just(new ActionEntry(RunPVE.value));
                  }) ])([ Halogen_HTML_Core.text("Play PVE") ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:100%; background-color:#2c2f33;") ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v1) {
                      return new Data_Maybe.Just(new ActionEntry(RunPVP.value));
                  }) ])([ Halogen_HTML_Core.text("Play PVP") ]) ]) ]);
              };
              if (v instanceof PVP) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:70%; background-color:#2c2f33;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;margin-top:10%") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display:inline-flex;width:100%;justify-self:center;margin-top:10%;background-color:transparent;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;left:0px;top:50px") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/mage.gif"), Halogen_HTML_Properties.height(150), Halogen_HTML_Properties.width(200) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:absolute;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;right:15%;") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/player2-mage.gif"), Halogen_HTML_Properties.height(200), Halogen_HTML_Properties.width(150) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:100%; background-color:#2c2f33;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;margin-top:10%") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("font: 40px Tahoma, Helvetica, Arial, Sans-Serif;text-align: center;color:orange;text-shadow: 0px 2px 3px #555;min-width:100%") ])([ Halogen_HTML_Core.text(fromJustString(Data_Array.index(myWords)(v.value0.wordCounter)) + (" " + (fromJustString(Data_Array.index(myWords)(v.value0.wordCounter + 1 | 0)) + (" " + fromJustString(Data_Array.index(myWords)(v.value0.wordCounter + 2 | 0)))))) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.id_("inp"), Halogen_HTML_Events.onValueChange(function (s) {
                      return new Data_Maybe.Just(new ActionPVP(new SendInputpvp(s)));
                  }), Halogen_HTML_Events.onFocus(function (s) {
                      return new Data_Maybe.Just(new ActionPVP(Updatepvp.value));
              ...
              if (v instanceof PVE) {
                  return Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:50%; background-color:#2c2f33;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;margin-top:10%") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("display:inline-flex;width:100%;justify-self:center;margin-top:10%;background-color:transparent;") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;left:0px;top:50px") ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/mage.gif"), Halogen_HTML_Properties.height(150), Halogen_HTML_Properties.width(200) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("position:relative;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;left:" + (Data_Show.show(Data_Show.showNumber)(v.value0.zombiePosition) + "px;")) ])([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src("images/zombie-pve.gif"), Halogen_HTML_Properties.height(200), Halogen_HTML_Properties.width(150) ]) ]) ]) ]), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.style("width:100%; background-color:#2c2f33;display:flex; flex-wrap:wrap;justify-content:center;justify-self:center;margin-top:10%") ])([ Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("font: 40px Tahoma, Helvetica, Arial, Sans-Serif;text-align: center;color:orange;text-shadow: 0px 2px 3px #555;min-width:100%") ])([ Halogen_HTML_Core.text(fromJustString(Data_Array.index(myWords)(v.value0.wordCounter)) + (" " + (fromJustString(Data_Array.index(myWords)(v.value0.wordCounter + 1 | 0)) + (" " + fromJustString(Data_Array.index(myWords)(v.value0.wordCounter + 2 | 0)))))) ]), Halogen_HTML_Elements.input([ Halogen_HTML_Properties.id_("inp"), Halogen_HTML_Events.onValueChange(function (s) {
                      return new Data_Maybe.Just(new ActionPVE(new SendInput(s)));
                  }), Halogen_HTML_Properties.style(" color:white; height:50px;width:150px; margin-left:20%; margin-top:5%; margin-bottom:10%;font-size:24px;border-color:orange;background-color:transparent;") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:yellow;font:40px Comic Sans;min-width:300px;text-align:center;") ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(v.value0.timer) + " seconds left") ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:lightblue;font:24px Comic Sans;min-width:300px;") ])([ Halogen_HTML_Core.text(" WPM: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showNumber))(v.value0.wpm)) ]), Halogen_HTML_Elements.p([ Halogen_HTML_Properties.style("color:lightgreen;font:24px Comic Sans;min-width:300px;") ])([ Halogen_HTML_Core.text("  Correct words: " + (Data_Show.show(Data_Show.showInt)(v.value0.wordCounter - v.value0.wrongWordCounter | 0) + (" " + (" Wrong words: " + Data_Show.show(Data_Show.showInt)(v.value0.wrongWordCounter))))) ]) ]) ]);
              };
              throw new Error("Failed pattern match at App.EntryPoint (line 286, column 5 - line 297, column 10): " + [ v.constructor.name ]);
          };
        
          //fixPVPmagicPosition
          // fixPVPmagicRender
  var handleActionPVP = function (v) {
                      ...
                      if (state instanceof PVP) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Show.show(Data_Show.showBoolean)(state.value0.timerIsRunning)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  var $57 = state.value0.timerIsRunning === false;
                                  if ($57) {
                                          ...
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                              ...
                                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                  return Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                                                      return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.forkAff(repeatAction(emitter)(1000.0)(new ActionPVP(new Decrementpvp(sid)))))(function () {
                                  ...
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.nowTime))(function (mynowtime) {
                                      ...
                                      var myText = fromJustString(Data_Array.index(myWords)(state.value0.wordCounter));
              ...
              if (v instanceof Decrementpvp) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                      if (state instanceof PVP) {
                          ...
                          var $61 = state.value0.timer > 0 && state.value0.particlesWidth > -50.0;
                          if ($61) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("AHA!"))(function () {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVP(function (st) {
                                      return {
                                          wrongWordCounter: st.wrongWordCounter,
                                          wordCounter: st.wordCounter,
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(SupJS.changeParticleSpeed(fromJustNumber(state.value0.wpm))(0.0))))(function () {
                                          return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(SupJS.resizeMagic(state.value0.particlesWidth)));
                                      });
                                  });
                              });
                          };
              ...
              throw new Error("Failed pattern match at App.EntryPoint (line 147, column 23 - line 214, column 39): " + [ v.constructor.name ]);
          };
          var handleActionPVE = function (v) {
              if (v instanceof SendInput) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                      if (state instanceof PVE) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Show.show(Data_Show.showBoolean)(state.value0.timerIsRunning)))(function () {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                                  var $67 = state.value0.timerIsRunning === false;
                                  if ($67) {
                                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Now.nowTime))(function (mynowtime) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
                      if (state instanceof PVE) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Show.show(Data_Show.showInt)(state.value0.timer)))(function () {
                              var newMagic = SupJS.resizeMagic(state.value0.zombiePosition);
                              var newtimer = state.value0.timer - 1 | 0;
                              var $71 = state.value0.timer > 0 && state.value0.zombiePosition > -50.0;
                              if ($71) {
                                  ...
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(updatePVE(function (st) {
                                      ...
                                      return Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(SupJS.changeParticleSpeed(fromJustNumber(state.value0.wpm))(0.0)));
                                  });
                              };
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.unsubscribe(v.value0))(function () {
                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(SupJS.disableInputBox(Data_Unit.unit)))(function () {
              ...
              throw new Error("Failed pattern match at App.EntryPoint (line 216, column 23 - line 284, column 30): " + [ v.constructor.name ]);
          };
          var handleActionEntry = function (v) {
              if (v instanceof RunPVE) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new PVE(initialPVEstate)))(function () {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit))(function () {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Socket_WebSocket.create("ws://localhost:3000")([  ])))(function (ws) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(100.0)))(function () {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Data_Functor["void"](Halogen_Query_HalogenM.functorHalogenM)(Halogen_Query_HalogenM.subscribe(Halogen_Query_EventSource.affEventSource(dictMonadAff)(function (emitter) {
                              ...
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.put(Halogen_Query_HalogenM.monadStateHalogenM)(new PVP(initialPVPstate(ws))))(function () {
              ...
              throw new Error("Failed pattern match at App.EntryPoint (line 123, column 25 - line 142, column 22): " + [ v.constructor.name ]);
          };
          var handleActionPicker = function (v) {
              ...
              throw new Error("Failed pattern match at App.EntryPoint (line 120, column 5 - line 120, column 81): " + [ v.constructor.name ]);
          };
