...
var pJS = function pJS(tag_id, params) {
  ...
  pJS.fn.particlesDraw = function () {
    ...
    pJS.particles.move.speed = document.getElementById("speedInput").value; //pJS.canvas.style.offsetWidth=document.getElementById("magicWidthField").value;

    var previousWidth = document.getElementById("particles-js").style.width; //canvas_el.style.width=document.getElementById("magicWidthField").value.toString()+"px";
    ...
    } catch (error) {} //pJS.canvas.w="1000px";
...
},{}]},{},["../../../../AppData/Roaming/npm/node_modules/parcel/src/builtins/hmr-runtime.js","particles.js"], null)
